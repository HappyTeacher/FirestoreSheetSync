...
var SUBTOPICS_DUMMY_SUBMISSIONS_COLUMN = {};
SUBTOPICS_DUMMY_SUBMISSIONS_COLUMN[ID] = 0;
SUBTOPICS_DUMMY_SUBMISSIONS_COLUMN[SUBTOPIC] = 1;
SUBTOPICS_DUMMY_SUBMISSIONS_COLUMN[AUTHOR_NAME] = 2;
SUBTOPICS_DUMMY_SUBMISSIONS_COLUMN[AUTHOR_INSTITUTION] = 3;
SUBTOPICS_DUMMY_SUBMISSIONS_COLUMN[AUTHOR_LOCATION] = 4;
SUBTOPICS_DUMMY_SUBMISSIONS_COLUMN[KEYS] = [SUBTOPIC, AUTHOR_NAME, AUTHOR_INSTITUTION, AUTHOR_LOCATION];
