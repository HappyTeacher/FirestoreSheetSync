...
SUBTOPICS_COLUMNS[AUTHOR_NAME] = 2;
SUBTOPICS_COLUMNS[AUTHOR_INSTITUTION] = 3;
SUBTOPICS_COLUMNS[AUTHOR_LOCATION] = 4;
SUBTOPICS_COLUMNS[NAME] = {};
SUBTOPICS_COLUMNS[NAME][ENGLISH_LOCALE] = 5;
SUBTOPICS_COLUMNS[NAME][MARATHI_LOCALE] = 6;
SUBTOPICS_COLUMNS[NAME][HINDI_LOCALE] = 7;
SUBTOPICS_COLUMNS[KEYS] = [NAME, AUTHOR_NAME, AUTHOR_INSTITUTION, AUTHOR_LOCATION];
